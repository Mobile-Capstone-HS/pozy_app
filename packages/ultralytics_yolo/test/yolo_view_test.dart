...
void main() {
  ...
  group('YOLOViewController', () {
    ...
    test('platform methods work with initialized channel', () async {
      controller.init(mockChannel, 1, 'mock_view_id');
  ...
  group('YOLOView Widget', () {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: YOLOView(
            ...
            task: YOLOTask.detect,
            controller: YOLOViewController()..init(mockChannel, 1, 'mock_view_id'),
            onResult: (results) {
    ...
    testWidgets('handles widget updates correctly', (
      ...
      final controller = YOLOViewController()..init(mockChannel, 1, 'mock_view_id');
