...
class PhotoEvaluationResult {
  ...
  /// Optional comparison note produced by the explanation service.
  final String? comparisonExplanation;

  /// Human-readable backend label for the explanation text.
  final String? explanationBackend;
  ...
  factory PhotoEvaluationResult.fromJson(Map<String, dynamic> json) {
    return PhotoEvaluationResult(
      ...
      finalAestheticScore: (json['final_aesthetic_score'] as num?)?.toDouble(),
      ...
      scoreDetails:
          (json['score_details'] as List<dynamic>?)
              ?.map(
                (entry) =>
                    ModelScoreDetail.fromJson(entry as Map<String, dynamic>),
              )
              .toList() ??
          const [],
      ...
      comparisonExplanation: json['comparison_explanation'] as String?,
      explanationBackend: json['explanation_backend'] as String?,
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (explanationBackend != null) 'explanation_backend': explanationBackend,
  ...
  factory PhotoEvaluationResult.fromScores({
    ...
    final normalizedAesthetic = (aestheticScore?.clamp(0.0, 1.0) as num?)
        ?.toDouble();
    ...
    return PhotoEvaluationResult(
      ...
      explanationBackend: explanationBackend,
      eyeState: eyeState,
  ...
  PhotoEvaluationResult copyWith({
    ...
    return PhotoEvaluationResult(
      ...
      comparisonExplanation:
          comparisonExplanation ?? this.comparisonExplanation,
      explanationBackend: explanationBackend ?? this.explanationBackend,
  ...
  Iterable<ModelScoreDetail> get technicalDetails => scoreDetails.where(
    (detail) => detail.dimension == ModelScoreDimension.technical,
  );

  Iterable<ModelScoreDetail> get aestheticDetails => scoreDetails.where(
